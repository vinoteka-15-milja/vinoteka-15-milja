...
$GLOBALS['V15_WC_SR'] = array(
    ...
    'Apply coupon' => 'Primeni kupon',
    'House number and street name' => 'Ulica i kućni broj',
    'Apartment, suite, unit, etc.' => 'Stan, sprat, itd.',
    'Apartment, suite, unit, etc. (optional)' => 'Stan, sprat, itd. (opciono)',
    'optional' => 'opciono',
    'District' => 'Okrug',
    'Notes about your order, e.g. special notes for delivery.' => 'Napomene o porudžbini, npr. posebne napomene za dostavu.',
    'Order notes (optional)' => 'Napomene uz porudžbinu (opciono)',
    'Select a country / region&hellip;' => 'Izaberite zemlju / region…',
    'Select an option&hellip;' => 'Izaberite…',
    'Ship to a different address?' => 'Dostava na drugu adresu?',
    'Update totals' => 'Ažuriraj iznos',
    'Update country / region' => 'Ažuriraj zemlju / region',
    'Shipment' => 'Pošiljka',
    'Serbia' => 'Srbija',
    'Belgrade' => 'Beograd',
    'Central Banat' => 'Srednji Banat',
    'North Banat' => 'Severni Banat',
    'South Banat' => 'Južni Banat',
    'Danube' => 'Podunavlje',
    'Pay for order' => 'Plati porudžbinu',
    // Sortiranje (shop)
